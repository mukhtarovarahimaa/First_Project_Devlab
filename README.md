...
19
Product lines
7 (Classic Cars, Vintage Cars, Motorcycles, Planes, Trucks, Ships, Trains)
SALES — Min
$482.13
SALES — Max
$14,082.80
...
0
ORDERDATE type
object → datetime64 (converted)
Missing Values
ADDRESSLINE2 (71%), STATE (29%), TERRITORY (38%), POSTALCODE (3%) — filled with "Unknown"
...
Recommendation: Develop premium customer programs for Denmark, Switzerland, Sweden, and Austria. 
